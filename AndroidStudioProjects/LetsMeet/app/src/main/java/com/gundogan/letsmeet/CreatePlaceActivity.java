...
public class CreatePlaceActivity extends AppCompatActivity {
    ...
    EditText nameText,typeText,detailsText;
    ImageView imageView;
    Bitmap chosenImage;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        typeText=findViewById(R.id.type_create_place_activity);
        detailsText=findViewById(R.id.atmosphere_create_place_activity);
    ...
    public void next(View view)
    {
        ...
        String placeDetails=detailsText.getText().toString();

        placesClass.setName(placeName);
        placesClass.setType(placeType);
        placesClass.setDetails(placeDetails);
