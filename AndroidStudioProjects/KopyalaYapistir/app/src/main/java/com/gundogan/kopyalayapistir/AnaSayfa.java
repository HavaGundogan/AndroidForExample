...
public class AnaSayfa extends AppCompatActivity {
    ...
    private AnanaSayfaBinding Binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = AnanaSayfaBinding.inflate(getLayoutInflater());
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.menuid) {
            Intent intent = new Intent(AnaSayfa.this, ArtActivity.class);
    ...
    private static class AnanaSayfaBinding {
    }
}